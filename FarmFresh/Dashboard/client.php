...
<body>
    ...
    <div class="accordion-container">
        ...
        <section class="dashboard">
            <div class="nav">
                <div><img src="images/home.svg" alt="Dashboard"> <span>Clients</span></div>
                <div>Overview</div>
            </div>
                        ...
                        if($result){
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo'<tr>';
                                    ...
                                    // echo'<td>'.$Role.'</td>';
                                    echo'<td>'.$tel.'</td>';
                                    echo '<td><a href="modifyclient.php?showid='.$Id.'">Modify</a>
                                    <a href="deleteclient.php?showid='.$Id.'" class="odd">Delete</a></td>';
                                echo'</tr>';               
                            }
