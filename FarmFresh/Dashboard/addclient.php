<?php
   ...
   $conn = mysqli_connect('localhost','root','','farm') or die("unable to connect to db");
    ...
    if(isset($_POST['submit'])){
       ...
       $sql = "INSERT INTO user(username, email, password, Image, tel, adress, Status)
               VALUES ('$name','$email', '$password',  '$fileName', '$tel','$adress', 'client')";
       ...
       // $fileActualExt = strtolower(end($fileExt));
        ...
        if($result){
           ...
           header("Location: client.php?uploadsuccess");
        }
...
<body>
    ...
    <div class="accordion-container">
        ...
        <section class="dashboard">
            <div class="nav">
                <div><img src="images/home.svg" alt="Dashboard"> <span>Add Client</span></div>
                <div>Overview</div>
            </div>
            <div class="formc">
