     ...
     <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="about.php" class="nav-item nav-link active">Vendor</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">The Vendors</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                ...
                <h2 class="display-5 ">We Are Professional Vendors</h2>
            </div>
            <div class="row g-5">
            ...
            <?php
                ...
                if($result){
                    ...
                    echo '<img class="img-fluid w-30 h-auto" src="Dashboard/images/'.$fileName.'" alt="">';
                    ...
                    echo '<div class="h-100 d-flex flex-column align-items-center justify-content-around bg-secondary py-5">';
                    ...
                    echo '<a class="btn btn-square rounded-circle bg-white" href="#"><i class="fab fa-instagram text-secondary"></i></a>';
                    echo '</div>';
                    echo ' </div>';
                    echo '</div>';
                    echo '</div>';
