<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO user(username, password, tel)
        VALUES ('$uname', '$password', '$tel')";
        ...
        if($result){
            ...
            header("Location:http://localhost/FarmFresh/FarmFresh/clientlogin.php");
        }
...
<div class="container " >
    ...
    <form action="" method="POST">
        <div class="form-group">
         ...
         <br>
            <div class="d-flex">
          <label for="text" class=""><h5><b>Tel:</b></h5></label>
          <input type="text" class="form-control my-0 ml-4" placeholder="Enter telephone" id="email" name="tel">
            </div>
         <br>
         <div class="d-flex">
