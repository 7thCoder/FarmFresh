...
<head>
    <meta charset="utf-8">
    <title>Btech- Organic Farm</title>
                ...
                <div class="col-lg-7">
                    <div class="bg-primary h-100 p-5">
                        <form action="" method="post">
                            <div class="row g-3">
                                <div class="col-6">
                                    <input name= "name" type="text" class="form-control bg-light border-0 px-4" placeholder="Your Name" style="height: 55px;">
                                </div>
                                <div class="col-6">
                                    <input  name= "email"type="email" class="form-control bg-light border-0 px-4" placeholder="Your Email" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <input  name= "subject" type="text" class="form-control bg-light border-0 px-4" placeholder="Subject" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <textarea  name= "message" class="form-control bg-light border-0 px-4 py-3" rows="2" placeholder="Message"></textarea>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="bg-secondary h-100 p-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">123 pk8, DLA, CMR</span>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">(+237)612345678</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container-fluid bg-dark text-white py-4">
    <div class="container text-center">
        <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">FarmFresh</a>. All Rights Reserved. Designed by <a class="text-secondary fw-bold" href="#">Group7</a></p>
    </div>
</div>
<!-- Footer End -->
